...
import { LoginOutlined, LogoutOutlined, HomeOutlined, ToTopOutlined, DownOutlined, RightOutlined  } from '@ant-design/icons';
...
function EfficiencyFlowChart({ data, parentNodes, chartLoading, onFetchData, onSetLevel, mode, forReport }){     
    ...
    useEffect(()=>{
        if( attrsCost && attrsCost['ele'] && !forReport ){
            // 控制能流图的整体缩放
    ...
    return (
                ...
                <div style={{ width:'100%', height:'100%', position:'relative', textAlign:'center' }} >
                    ...
                    <div style={{ position:'absolute', top:'0', right:'0', backgroundColor:'#ade6f6', color:'#000', textAlign:'center', padding:'20px' }}>
                        <div>能源成本竞争力</div>
                        <div style={{ fontSize:'1.4rem', fontWeight:'bold' }}>排名第<span style={{ fontWeight:'bold', color:'red'}}>{ data.rank ? data.rank : '' }</span>位</div>
                    </div>
                    ...
                    <div style={{ position:'absolute', top:'80px', bottom:'20px', left:'20px', right:'20px'}} ref={containerRef} >
                        <svg 
                            width='100%'
                            height='100%'
