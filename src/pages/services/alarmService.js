...
export function getWarningAnalyze(data = {}){
    let token = apiToken();
    data.token = token;
    let str = translateObj(data);
...
export function getMachWarning(data = {}){
    let token = apiToken();
    data.token = token;
    let str = translateObj(data);
    return request('/warn/machwarningrank', { 
        method:'POST',
        headers: {
            'Content-Type': 'application/x-www-form-urlencoded'
        },
...
export function getFieldWarning(data = {}){
    let token = apiToken();
    data.token = token;
    let str = translateObj(data);
    return request('/warn/attrwarningrank', { 
        method:'POST',
        headers: {
            'Content-Type': 'application/x-www-form-urlencoded'
        },
