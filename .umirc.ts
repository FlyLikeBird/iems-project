        ...
        routes:[
            ...
            // 能源效率模块
            {
                ...
                routes:[
                    ...
                    { path:'/energy/energy_eff/ep_trend', component:'@/pages/analyze_page/EPChartTrend'}
            ...
            // 分析中心模块
            {
                ...
                routes:[
                    ...
                    { path:'/energy/analyze_manage/ep_chart', component:'@/pages/analyze_page/EPChartManager'}
                ]
            },
            // 统计报表模块
            {
            ...
            {
                path:'/energy',
                component:'@/pages/page_index/GlobalMonitor'
            },
            {
                path:'/',
                component:'@/pages/page_index/GlobalMonitor'
