...
function GlobalMonitor({ dispatch, monitor, user, children }){
            ...
            <div className={style['content-container']}>
                ...
                <div className={style['bottom-container']}>
                    ...
                    <div className={style['middle']}>
                        {/* 今日负荷 */}
                        <div className={style['item-container']} style={{ height:'100%' }}>
                            <div className={style['title']}><div><DashboardOutlined />{ `今日负荷(kw)` }</div></div>
                            <div className={style['flex-item']} >
                                {
...
export default connect( ({ monitor, user })=>({ monitor, user }))(GlobalMonitor);
