import { getTodaySumInfo, getTodayWarning, getEnergyPercent, getFieldCost, getEnergyTrend } from '../services/xiaoeIndexService';
...
export default {
    ...
    effects:{
        ...
        *fetchEnergyTrend(action, { select, call, put}){
            let { user:{ company_id }, fields:{ energyInfo }, xiaoe:{ dataType, timeType }} = yield select();
