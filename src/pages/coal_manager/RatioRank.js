...
function EffRank({ dispatch, user, fields, carbon }){
        ...
        <div style={{ position:'relative' }}>
            ...
            <div style={{ height:'calc( 100% - 40px)'}}>
                <div className={style['card-container']}>
                {
                    ...
                    ?                
                    <EffLineChart data={carbonEff} theme={user.theme} info={{ tab:'万元产值比', key:'2', unit:'元/万元' }} startDate={user.startDate} timeType={user.timeType} />                                  
                    :
    ...
    useEffect(()=>{
        ...
        dispatch({ type:'carbon/initCarbonEff', payload:{ type:'2' }});                                                     
    },[])
    return (
