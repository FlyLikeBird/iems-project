...
function IndexManager({ dispatch, user, fields, xiaoe }){
    // console.log('index render()');
    let { energyList, energyInfo } = fields;
    let { energyData, warningList, warningLoading, energyPercent, chartInfo, energyType, timeType, dataType, attrChartInfo, attrChartLoading } = xiaoe;
    useEffect(()=>{
        dispatch({ type:'xiaoe/init'});
        return ()=>{
            dispatch({ type:'xiaoe/reset'});
    ...
    return (
        <div className={style['page-container']}>
            ...
            {/* 底部模块 */}
            <div className={style['card-container-wrapper']} style={{ display:'block', height:'40%', paddingRight:'0', paddingBottom:'0' }}>
...
export default connect(({ user, fields, xiaoe })=>({ user, fields, xiaoe }))(IndexManager);