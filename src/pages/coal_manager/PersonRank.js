...
function EffRank({ dispatch, user, fields, carbon }){
        ...
        <div className={style['card-container']}>
                <Tabs className={style['custom-tabs']} activeKey={energyInfo.type_id} onChange={activeKey=>{
                    ...
                    .then((node)=>{
                        ...
                        dispatch({ type:'carbon/fetchTypeRule', payload:{ warning_type:'human_effect'}})
                    })
                }}>
                    {
        ...
        <div style={{ position:'relative' }}>
            ...
            <div style={{ height:'calc( 100% - 40px)'}}>
                <div className={style['card-container']}>
                {
                    ...
                    ?                
                    <EffLineChart data={carbonEff} theme={user.theme} currentAttr={currentAttr} typeRule={typeRule} dispatch={dispatch} info={{ tab:'人当能效', key:'1', unit:'元/人', warning_type:'human_effect' }} startDate={user.startDate} timeType={user.timeType} />                                  
                    :
    ...
    useEffect(()=>{
        ...
        dispatch({ type:'carbon/initCarbonEff', payload:{ type:'1', warning_type:'human_effect' }});                                                     
    },[])
    return (
