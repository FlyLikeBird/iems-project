...
function UserForm({ companyList, roleList, userForm, forEdit, onAdd, onVisible }){
    const { agent_id, agent_name, company_id, company_name, create_time, email, is_actived, last_login_ip, last_login_time, phone, role_id, role_name, user_id, user_name } = userForm;
    ...
    return (
            ...
            >
                ...
                </Form.Item>
                {
                    ...
                    null
                    :
                    <Form.Item name='password' label="密码" rules={[{ required:true , message:'密码不能为空'}, { pattern:passwordReg, message:msg, validateTrigger:'onBlur'}]}>
                ...
                }
                {
                    ...
                    null
                    :
                    <Form.Item name='confirm_password' label="确认密码" rules={[{ required:true , message:'密码不能为空'},{ pattern:passwordReg, message:msg, validateTrigger:'onBlur'}]}>
