...
function UseLessManager({ dispatch, user, fields, demand }) {
    ...
    useEffect(()=>{
        return ()=>{
            dispatch({ type:'demand/resetUseless'});
        }
    },[]);
    const sidebar = (
        <div>
            ...
            <div style={{ height:'calc( 100% - 40px)'}}>
                ...
                <div className={style['card-container-wrapper']} style={{ height:'80%', paddingRight:'0', paddingBottom:'0' }}>
                    <div className={style['card-container']}>
                    {
                        ...
                        : 
                        <UselessChart data={uselessInfo} theme={user.theme} />   
                    }
                    </div>
                </div>
...
export default connect(({ user, demand, fields })=>({ user, demand, fields }))(UseLessManager);
