...
function EffRank({ dispatch, user, fields, carbon }){
        ...
        <div style={{ position:'relative' }}>
            ...
            <div style={{ height:'calc( 100% - 40px)'}}>
                <div className={style['card-container']}>
                {
                    ...
                    ?                
                    <EffLineChart data={carbonEff} theme={user.theme} info={{ tab:'产量能效', key:'5', unit:'元/件'}} startDate={user.startDate} timeType={user.timeType} />                                  
                    :
    ...
    useEffect(()=>{
        ...
        dispatch({ type:'carbon/initCarbonEff', payload:{ type:'5' }});                                                     
    },[])
    return (
