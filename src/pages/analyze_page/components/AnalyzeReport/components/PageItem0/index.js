...
function PageItem0({ analyze, monitor, dispatch, companyName }){
    const { rankAndGrade, eleHealth, reportInfo } = analyze;
    const { saveSpace } = monitor;
    const [rankTimeType, toggleRankTimeType] = useState('2');
    const [healthTimeType, toggleHealthTimeType] = useState('1');
            ...
            <div style={{ display:'flex', justifyContent:'space-between' }}>
                ...
                <div>
                    <Radio.Group size='small' buttonStyle="solid" value={rankTimeType} onChange={e=>{
                        ...
                        {/* <Radio.Button key='0' value='1'>本日</Radio.Button> */}
