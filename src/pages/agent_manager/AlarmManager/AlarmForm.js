...
function AlarmForm({ info, progressLog, logTypes, onClose, onOk, onDispatch }){
                ...
                <Form
                    ...
                    onFinish={values=>{
                        new Promise((resolve,reject)=>{            
                            ...
                            onDispatch({type:'agentMonitor/confirmRecord', payload:{ resolve, reject, values }}); 
                        })
                        .then(()=>{
                            onClose();
                            onOk();
                            onDispatch({ type:'user/updateAgentAlarm'});
                        })
                        .catch(msg=>{
                            message.error(msg);
